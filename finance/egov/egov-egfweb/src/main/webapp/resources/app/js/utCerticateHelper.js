...
function callAjaxSearch() {
    ...
    drillDowntableContainer.dataTable({
        ajax: {
            url: "/services/EGF/utilization_certificate/ajaxsearch/" + $('#mode').val(),
            type: "POST",
        ...
        fnRowCallback: function(row, data) {
            $(row).on('click', function() {
                window.open('/services/EGF/utilization_certificate/' + $('#mode').val() + '/' + data.id,
                    '',
        ...
        buttons: [
			{
								    ...
								    action: function(e, dt, node, config) {
										...
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">UC Number</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Grant/Scheme</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Financial Year</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Grant Amount</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Previous Balance</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Utilized Balance</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Unutilized Balance</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Total Available Balance</th>';
								...
								},
            {
                ...
                filename: 'Utilization Certificate',
            ...
            {
                extend: 'excel',
                message: 'Utilization Certificate',
                filename: 'Utilization Certificate'
            }
        ],
        ...
        columns: [
            ...
            { data: "unutilisedBalance", sClass: "text-right" },
            { data: "totalAvailableFunds", sClass: "text-right" }
        ]
    });
}
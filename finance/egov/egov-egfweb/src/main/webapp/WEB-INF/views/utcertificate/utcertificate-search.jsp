...
<form:form role="form" action="search" modelAttribute="uTCertificateSearchRequest" id="uTCertificateSearchRequestsearchform"
      ...
      <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
          <div class="panel-heading">
            <div class="panel-title"><spring:message text="Search Utilization"/> </div>
          </div>
          <div class="panel-body">
            <div class="form-group">
            <label class="col-sm-3 control-label text-right"><spring:message text="UC Number"/> </label>
              <div class="col-sm-3 add-margin">
                <form:input path="ucNumber" class="form-control text-left patternvalidation" data-pattern="alphanumeric"
                  maxlength="50" />
                <form:errors path="ucNumber" cssClass="error-msg" />
              </div>
            </div>
...
<div class="row display-hide report-section">
  <div class="col-md-12 table-header text-left"><spring:message text="Utilization Certificate Search Result"/></div>
    ...
    <table class="table table-bordered table-hover multiheadertbl" id="resultTable">
      <thead>
        <tr>
          ...
          <th><spring:message  text="Unutilised Balance"/></th>
          <th><spring:message text="Total Available Funds"/></th>
        </tr>
      </thead>
    </table>
  </div>
...
<script type="text/javascript" src="<cdn:url value='/resources/app/js/utCerticateHelper.js?rnd=${app_release_no}'/>"></script>

...
<s:form theme="simple" name="displayReceiptForm">
	...
	<input name="buttonClose" type="button" class="button"	id="buttonClose" value="<s:text name='lbl.close'/>" onclick="window.location.href='/services/collection/receipts/searchReceipt-search.action';" />
	</div>
</s:form>
</body>
</html>
